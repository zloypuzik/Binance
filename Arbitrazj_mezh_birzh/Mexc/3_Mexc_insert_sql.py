...
exchange = "Mexc"
getAllSymbolsExchange = Classes.def_FileOpenGetAllSymbols(exchange)
...
def def_getOrderbookExchange():
    return client.bookTicker_info()
...
for gei_fileGetAllSymbolsBinance in getAllSymbolsExchange:
...
def runMainProgram():
    ...
    for i_requestPricesBinance in def_getOrderbookExchange():
